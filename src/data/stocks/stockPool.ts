...
export const stockPool: Stock[] = [
  ...
  stock('us-technology-apple', '苹国', 'us', 'technology', 'leader', 0.1, 0.22, 98, '消费电子现金牛，跌起来也会提醒你信仰有价格。'),
  stock('us-technology-microsoft', '微硬', 'us', 'technology', 'leader', 0.12, 0.24, 97, '云和软件双保险，属于大佬们抱团取暖的热门座位。'),
  stock('us-technology-alphabet', '谷鸽', 'us', 'technology', 'growth', 0.11, 0.27, 92, '搜索广告老钱叠 AI 新故事，估值脸色看利率。'),
  ...
  stock('us-consumer-tesla', '特思拉', 'us', 'consumer', 'growth', 0.16, 0.45, 90, '电动车情绪过山车，上车前最好确认安全带还在。'),
  ...
  stock('a-share-consumer-kweichow-moutai', '贵州茅坛', 'a-share', 'consumer', 'leader', 0.09, 0.22, 100, '白酒信仰压舱石，行情差时也会被拿来做心理按摩。'),
